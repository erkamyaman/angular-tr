    ...
    children: [
      {
        ...
        children: [
          ...
          {
            label: '`debounced` ile sinyalleri geciktirme',
      ...
      },
      {
        ...
        children: [
          ...
          {
            label: "Service'leri lazy loading ile yükleme",
