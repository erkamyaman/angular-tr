...
export interface Step {
  step: string;
  /**
   * Markdown olarak işlenen eylem metni. Bağlantılar için Markdown bağlantı
   * söz dizimini `[metin](url)` kullanın; ham `<a>` HTML etiketleri
   * `update.component.ts` içindeki özel bağlantı işleyicisini atlar ve
   * `target="_blank"` ya da harici bağlantı simgesini almaz.
   */
  action: string;
  possibleIn: number;
...
export const RECOMMENDATIONS: Step[] = [
  ...
  },
  {
    ...
    step: 'gendir',
    action:
      "`gendir`'e bağımlı olmayın, bunun yerine `skipTemplateCodeGen` kullanmayı değerlendirin. [Daha Fazla Bilgi](https://github.com/angular/angular/issues/19339#issuecomment-332607471)",
  },
  {
    possibleIn: 220,
    necessaryAsOf: 600,
  ...
  },
  {
    ...
    action:
      "Angular CLI'nizi güncelleyin ve aşağıdaki komutu çalıştırarak yapılandırmayı [yeni angular.json formatına](https://github.com/angular/angular-cli/wiki/angular-workspace) taşıyın:<br/><br/>`NG_DISABLE_VERSION_CHECK=1 npx @angular/cli@6 update @angular/cli@6`<br/>",
  },
  {
    possibleIn: 600,
    necessaryAsOf: 600,
    ...
    step: 'Update to CLI v6',
    action:
      'Angular CLI\'nizi güncelleyin ve aşağıdaki komutu çalıştırarak yapılandırmayı [yeni angular.json formatına](https://github.com/angular/angular-cli/wiki/angular-workspace) taşıyın:<br/><br/>`cmd /C "set "NG_DISABLE_VERSION_CHECK=1" && npx @angular/cli@6 update @angular/cli@6 @angular/core@6"`<br/>',
  },
  {
    possibleIn: 600,
    necessaryAsOf: 600,
  ...
  },
  {
    ...
    action:
      '[rxjs-tslint otomatik güncelleme kurallarını](https://github.com/ReactiveX/rxjs-tslint) kullanarak kullanımdan kaldırılmış RxJS 5 özelliklerini kaldırın<br/><br/>Çoğu uygulama için bu, aşağıdaki iki komutu çalıştırmak anlamına gelir:<br/><br/>`npx rxjs-tslint`<br/>`rxjs-5-to-6-migrate -p src/tsconfig.app.json`',
  },
  {
    possibleIn: 600,
    necessaryAsOf: 800,
  ...
  },
  {
    ...
    step: 'TypeScript 3.1',
    action:
      'Angular artık TypeScript 3.1 kullanıyor, [olası uyumsuz değişiklikler](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-3-1.html) hakkında daha fazla bilgi edinin.',
  },
  {
    possibleIn: 700,
    necessaryAsOf: 700,
    ...
    step: 'Node 10',
    action:
      'Angular artık [Node 10](https://nodejs.org/en/blog/release/v10.0.0/) desteği eklemiştir.',
  },
  {
    possibleIn: 700,
    necessaryAsOf: 700,
...

  {
    ...
    step: 'v10 Node.js 12',
    action:
      '[Node 12 veya üstünü](https://nodejs.org/dist/latest-v12.x/) kullandığınızdan emin olun.',
  },
  {
    possibleIn: 1000,
    necessaryAsOf: 1000,
  ...
  },
  {
    ...
    step: 'esm5-bundles',
    action:
      "[Angular Paket Formatı](https://angular.dev/tools/libraries/angular-package-format), `esm5` ve `fesm5` formatlarını kaldırmak için güncellendi. Bunlar artık npm paketlerimizde dağıtılmamaktadır. CLI kullanmıyorsanız, Angular kodunu kendiniz ES5'e dönüştürmeniz gerekebilir.",
  },
  {
    possibleIn: 1000,
    necessaryAsOf: 1000,
  ...
  },
  {
    ...
    step: 'TypeScript 4.4',
    action:
      'Angular artık TypeScript 4.4 kullanıyor, [olası kırılma değişiklikleri](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-4-4.html) hakkında daha fazla bilgi edinin.',
  },
  {
    possibleIn: 1300,
    necessaryAsOf: 1300,
  ...
  },
  {
    ...
    step: 'TypeScript 4.6',
    action:
      'Angular artık TypeScript 4.6 kullanıyor, [olası kırılma değişiklikleri](https://devblogs.microsoft.com/typescript/announcing-typescript-4-6/) hakkında daha fazla bilgi edinin.',
  },
...

  {
    ...
    action:
      "Uygulamanızı yükseltmeden önce desteklenen bir node.js sürümü kullandığınızdan emin olun. Angular v15, node.js sürümleri: 14.20.x, 16.13.x ve 18.10.x'i destekler. [Daha fazla bilgi](https://v15.angular.io/guide/update-to-version-15#v15-bc-01)",
  },
  {
    possibleIn: 1500,
    necessaryAsOf: 1500,
    ...
    step: 'v15 ts support',
    action:
      'Uygulamanızı yükseltmeden önce desteklenen bir TypeScript sürümü kullandığınızdan emin olun. Angular v15, TypeScript sürüm 4.8 veya üstünü destekler.  [Daha fazla bilgi](https://v15.angular.io/guide/update-to-version-15#v15-bc-02)',
  },
  {
    possibleIn: 1500,
    necessaryAsOf: 1500,
  ...
  },
  {
    ...
    action:
      "Constructor'ları miras alan ve bağımlılık enjeksiyonu kullanan alt sınıflara sahip temel sınıflarda dekoratör kullandığınızdan emin olun. Bu tür temel sınıflar `@Injectable` veya `@Directive` ile dekore edilmelidir, aksi takdirde derleyici hata döndürür. [Daha fazla bilgi](https://v15.angular.io/guide/update-to-version-15#v15-bc-05)",
  },
  {
    possibleIn: 1500,
    necessaryAsOf: 1500,
    ...
    action:
      "v15'te, bir `ControlValueAccessor` eklendiğinde `setDisabledState` her zaman çağrılır. Bu davranışı devre dışı bırakmak için `FormsModule.withConfig` veya `ReactiveFormsModule.withConfig` kullanın. [Daha fazla bilgi](https://v15.angular.io/guide/update-to-version-15#v15-bc-06)",
  },
  {
    possibleIn: 1500,
    necessaryAsOf: 1500,
    ...
    step: 'v15 canParse',
    action:
      "`canParse` kullanan uygulamalar bunun yerine `@angular/localize/tools` paketindeki `analyze` metodunu kullanmalıdır. v15'te `canParse` metodu `@angular/localize/tools` içindeki tüm çeviri ayrıştırıcılarından kaldırılmıştır.  [Daha fazla bilgi](https://v15.angular.io/guide/update-to-version-15#v15-bc-07)",
  },
  {
    possibleIn: 1500,
    necessaryAsOf: 1500,
    ...
    action:
      "Tüm `ActivatedRouteSnapshot` nesnelerinin bir `title` özelliğine sahip olduğundan emin olun. v15'te `title` özelliği `ActivatedRouteSnapshot` için zorunlu bir özelliktir. [Daha fazla bilgi](https://v15.angular.io/guide/update-to-version-15#v15-bc-08)",
  },
  {
    possibleIn: 1500,
    necessaryAsOf: 1500,
    ...
    action:
      "`RouterOutlet` ile testleriniz bozuluyorsa, değişiklik algılamaya göre ilgili bileşenin oluşturulma sırasına bağlı olmadıklarından emin olun. v15'te `RouterOutlet` bileşeni değişiklik algılamadan sonra oluşturur. [Daha fazla bilgi](https://v15.angular.io/guide/update-to-version-15#v15-bc-09)",
  },
  {
    possibleIn: 1500,
    necessaryAsOf: 1500,
    ...
    action:
      "v15'te `relativeLinkResolution` Router'da yapılandırılabilir değildir. Bu seçenek, artık standart olan önceki bir hata düzeltmesini devre dışı bırakmak için kullanılıyordu.  [Daha fazla bilgi](https://v15.angular.io/guide/update-to-version-15#v15-bc-10)",
  },
  {
    possibleIn: 1500,
    necessaryAsOf: 1500,
    ...
    action:
      "Saat dilimlerini yapılandırmak için `DATE_PIPE_DEFAULT_TIMEZONE` token kullanımlarını `DATE_PIPE_DEFAULT_OPTIONS` kullanacak şekilde değiştirin. v15'te `DATE_PIPE_DEFAULT_TIMEZONE` tokeni kullanımdan kaldırılmıştır. [Daha fazla bilgi](https://v15.angular.io/guide/update-to-version-15#v15-dp-01)",
  },
  {
    possibleIn: 1500,
    necessaryAsOf: 1500,
  ...
  },
  {
    ...
    action:
      "`InjectFlags` parametresi kullanan `Injector.get()` kullanımlarını `InjectOptions` parametresi kullanacak şekilde güncelleyin. `Injector.get()` metodunun `InjectFlags` parametresi v15'te kullanımdan kaldırılmıştır. [Daha fazla bilgi](https://v15.angular.io/guide/update-to-version-15#v15-dp-02)",
  },
  {
    possibleIn: 1500,
    necessaryAsOf: 1500,
    ...
    action:
      "`InjectFlags` parametresi kullanan `TestBed.inject()` kullanımlarını `InjectOptions` parametresi kullanacak şekilde güncelleyin. `TestBed.inject()` metodunun `InjectFlags` parametresi v15'te kullanımdan kaldırılmıştır. [Daha fazla bilgi](https://v15.angular.io/guide/update-to-version-15#v15-dp-01)",
  },
  {
    possibleIn: 1500,
    necessaryAsOf: 1500,
    ...
    action:
      "`@Injectable` ve `InjectionToken` için `providedIn: ngModule` kullanımı v15'te kullanımdan kaldırılmıştır. [Daha fazla bilgi](https://v15.angular.io/guide/update-to-version-15#v15-dp-04)",
  },
  {
    possibleIn: 1500,
    necessaryAsOf: 1500,
    ...
    action:
      "`@Injectable` veya `InjectionToken` için `providedIn: 'any'` kullanımı v15'te kullanımdan kaldırılmıştır. [Daha fazla bilgi](https://v15.angular.io/guide/update-to-version-15#v15-dp-05)",
  },
  {
    possibleIn: 1500,
    necessaryAsOf: 1500,
    ...
    action:
      "`RouterLinkWithHref` direktifinin kullanımlarını `RouterLink` direktifini kullanacak şekilde güncelleyin. `RouterLinkWithHref` direktifi v15'te kullanımdan kaldırılmıştır. [Daha fazla bilgi](https://v15.angular.io/guide/update-to-version-15#v15-dp-06)",
  },
  {
    possibleIn: 1500,
    necessaryAsOf: 1500,
    ...
    action:
      "Angular Material v15'te birçok bileşen, resmi Material Design Components for Web (MDC) tabanlı olacak şekilde yeniden düzenlenmiştir. Bu değişiklik birçok bileşenin DOM ve CSS sınıflarını etkilemiştir. [Daha fazla bilgi](https://rc.material.angular.dev/guide/mdc-migration)",
  },
  {
    possibleIn: 1500,
    necessaryAsOf: 1500,
  ...
  },
  {
    ...
    action:
      "Angular v20'ye yükseltmeden önce Node.js sürümünüzün en az 20.11.1 olduğundan ve v18 veya v22.0-v22.10 olmadığından emin olun. [Desteklenen Node.js sürümlerinin tam listesini](https://angular.dev/reference/versions) kontrol edin.",
  },
  {
    possibleIn: 2000,
    necessaryAsOf: 2000,
  ...
  },
  {
    ...
    action:
      "`tsconfig.json` dosyanızda `moduleResolution` seçeneğini `'bundler'` olarak ayarlayın. Angular CLI'nin `ng update` migrasyonu bu değişikliği otomatik olarak uygular; manuel olarak yükseltiyorsanız veya bu seçeneği bir temel tsconfig içinde geçersiz kılıyorsanız, `@angular/core/rxjs-interop` gibi ikincil giriş noktalarının import'larının doğru şekilde çözümlenmeye devam etmesi için bunu açıkça ayarlayın.",
  },
  {
    possibleIn: 2000,
    necessaryAsOf: 2000,
  ...
  },
  {
    ...
    action:
      "`@angular/ssr` 21.1.5 sürümünden itibaren, uygulamanız `CommonEngine` ile SSR kullanıyorsa, `server.ts` dosyanızda `allowedHosts` seçeneğini ayarlayın (örneğin, `new CommonEngine({allowedHosts: ['localhost', '*.yourdomain.com']})`). Bu seçenek olmadan SSR sessizce istemci tarafında işlemeye geri döner. Bu gereksinim, [GHSA-x288-3778-4hhx](https://github.com/angular/angular-cli/security/advisories/GHSA-x288-3778-4hhx) güvenlik danışma belgesinden kaynaklanmaktadır (ayrıca 20.3.17 ve 19.2.21 sürümlerine de geri taşınmıştır).",
  },
  {
    action:
      "Uygulamanın proje dizininde, uygulamanızı Angular v22'ye güncellemek için `ng update @angular/core@22 @angular/cli@22` komutunu çalıştırın.",
    level: ApplicationComplexity.Basic,
    necessaryAsOf: 2200,
    possibleIn: 2200,
...

  {
    ...
    material: true,
    step: 'update @angular/material',
    action: '`ng update @angular/material@22` komutunu çalıştırın.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      'Angular v22, Node.js v22.22.3 veya v24.15.0 ve üzeri sürümleri gerektirir. Node.js sürümünüzü bu minimum gereksinimi karşılayacak şekilde güncelleyin. Mevcut sürümünüzü `node --version` ile kontrol edebilirsiniz.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      "Projenizi TypeScript 6.0 veya üzerini kullanacak şekilde güncelleyin. 6.0'dan eski sürümler artık desteklenmemektedir. Bunu otomatik olarak yapacak olan `ng update` komutunu kullanın.",
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      'Data önekli öznitelikler (örneğin, `data-*`) artık input veya output\'lara bağlanmaz. Bu davranışa güveniyorduysanız, bunun yerine açık özellik bağlamaları kullanın (örneğin, `[attr.data-value]="value"` veya bir bileşen input\'u için `[dataValue]="value"`).',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      "Derleyici artık input'lar, output'lar veya model aynı özelliğe/output'a bağlandığında bir hata fırlatır. Bileşen dekoratörlerinizi gözden geçirin ve yinelenen bağlama olmadığından emin olun.",
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      'Güvenli gezinme (`?.`) ve nullish coalescing (`??`) artık şablonlardaki nullable türleri doğru şekilde daraltır. Bu, mevcut projelerde `nullishCoalescingNotNullable` ve `optionalChainNotNullable` tanılamalarını tetikleyebilir. Şablonlarınızı güncelleyerek tanılamaları düzeltin veya `tsconfig.json` dosyanızda `angularCompilerOptions` altında bunları geçici olarak devre dışı bırakın.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      'İsteğe bağlı zincirleme (`?.`) içeren Angular ifadeleri artık `null` yerine `undefined` döndürür. Önceki davranışa geri dönmek için `$safeNavigationMigration()` sihirli fonksiyonunu kullanabilirsiniz.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
  ...
  },
  {
    ...
    action:
      "Şablon ifadelerindeki `in` değişkenleri artık native JavaScript'te olduğu gibi bir hata fırlatır. Bileşeninizde veya şablonunuzda `in` adlı değişkenler varsa, şablon ifadelerinizi `this.in` kullanacak şekilde güncelleyin veya değişkeninizi yeniden adlandırın.",
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      '`AnimationCallbackEvent.animationComplete` imzası değişmiştir. Bu olayın eski imzasına bağımlı olan kodları güncelleyin. Animasyon olay işleyicilerinizi ve testlerinizi gözden geçirin.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      'Uygulamanız `HttpXhrBackend` aracılığıyla yükleme ilerleme raporlaması kullanıyorsa, `provideHttpClient(withXhr())` kullanarak açıkça etkinleştirin. Varsayılan HTTP istemcisi artık varsayılan olarak XHR desteği içermez.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      'HTTP isteklerindeki `reportProgress` seçeneği kullanımdan kaldırılmıştır. İlerleme raporlaması üzerinde daha açık kontrol için bunun yerine `reportUploadProgress` veya `reportDownloadProgress` kullanın.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      '`@angular/platform-server` içindeki XHR desteği kullanımdan kaldırılmıştır ve Angular 23 sürümünde kaldırılması planlanmaktadır. Altta yatan `xhr2` kütüphanesi yönlendirmeleri güvenli bir şekilde işlemez (örneğin, çapraz kaynaklı yönlendirmelerde `Authorization` başlıklarını iletebilir ve yönlendirme döngüleri aracılığıyla DoS saldırılarına karşı savunmasızdır). Sunucu tarafı işleme için `withXhr()` yerine varsayılan `fetch` arka ucunu kullanın.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      '`provideRoutes()` kaldırılmıştır. Bunun yerine `provideRouter()` kullanın veya gerekirse rotaları `ROUTES` kullanarak bir multi token olarak yapılandırın. Uygulama bootstrap yapılandırmanızı güncelleyin.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      'AngularJS birlikte çalışabilirliği kullanıyorsanız, kullanımdan kaldırılmış `getAngularLib()` ve `setAngularLib()` fonksiyonlarını sırasıyla `getAngularJSGlobal()` ve `setAngularJSGlobal()` ile değiştirin.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      "`ComponentFactoryResolver` ve `ComponentFactory` artık kullanılamaz. Bileşen sınıfını doğrudan `ViewContainerRef.createComponent()` gibi API'lere geçirin veya bunun yerine bağımsız `createComponent()` fonksiyonunu kullanın.",
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      '`createNgModuleRef` kaldırılmıştır. Dinamik modül oluşturma senaryoları için bunun yerine `createNgModule()` kullanın.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      'Birden fazla eşleşen seçiciye sahip elementler artık derleme zamanında bir hata fırlatır. Bileşenlerinizin benzersiz seçiciler kullandığından emin olun ve çakışan seçicileri olabilecek direktifleri gözden geçirin.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      "Tanımlı bir `changeDetection` özelliği olmayan bileşenler artık varsayılan olarak `OnPush`'tur. `Eager` (önceki varsayılan) değişiklik algılamasını korumak için, bileşen dekoratörünüzde `changeDetection: ChangeDetectionStrategy.Eager` değerini açıkça ayarlayın.",
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      '`ChangeDetectorRef.checkNoChanges()` kaldırılmıştır. Testlerde bunun yerine `fixture.detectChanges()` kullanın veya bileşen durumunuzu başka yollarla doğrulayın.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      'Çıkış (leave) animasyonları artık yalnızca kaldırılan elementle sınırlı değildir. Artık bileşen sınırlarına göre kapsamlandırılmış iç içe animasyonları destekler. Önceki kapsamlandırma davranışına güveniyorduysanız animasyon yapılandırmalarınızı gözden geçirin.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      '`paramsInheritanceStrategy` artık `"emptyOnly"` yerine varsayılan olarak `"always"` değerine sahiptir. Bu, rota parametrelerinin tüm üst rotalardan miras alındığı anlamına gelir. Önceki davranışı geri yüklemek için, router yapılandırmanızda `paramsInheritanceStrategy: "emptyOnly"` değerini açıkça ayarlayın.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      '`CanMatchFn` içindeki `currentSnapshot` parametresi ve `CanMatch` arayüzünün `canMatch` metodu artık zorunludur. `CanMatch` arayüzünü uygulayan tüm sınıfları bu zorunlu üçüncü argümanı içerecek şekilde güncelleyin.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      "Hammer.js entegrasyonu Angular platform-browser'dan kaldırılmıştır. Dokunmatik hareket desteğine ihtiyacınız varsa, kendi hareket algılamanızı uygulayın veya alternatif bir kitaplık kullanın.",
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      '`appRef.bootstrap()` metodunun ikinci argümanı artık `any` türünü kabul etmez. Geçirdiğiniz elementin nullable olmadığından ve beklenen türle eşleştiğinden emin olun.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      "Kullanılmayan stiller, ilişkili `host`'ları kaldırıldığında artık otomatik olarak kaldırılır. Bu stiller Angular dışındaki elementler tarafından kullanılıyorsa veya `ViewEncapsulation.Emulated` kullanılmıyorsa, sayfadaki diğer DOM'un etkilenebileceğini unutmayın.",
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      "`TitleStrategy.getResolvedTitleForRoute` için dönüş türü `any`'den daha katı bir türe (örneğin, `string | undefined`) değişmiştir. Özel `TitleStrategy` uygulamalarınızı yeni imzayla eşleşecek şekilde güncelleyin.",
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      'Artımlı hidrasyon (incremental hydration), artık Sunucu Tarafı İşleme (SSR) kullanan uygulamalar için varsayılan davranıştır. Önceki artımlı olmayan hidrasyon davranışına güveniyorduysanız uygulamanızı gözden geçirin. Gerekirse önceki davranışı geri yüklemek için `withNoIncrementalHydration()` kullanabilirsiniz.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      '`fullTemplateTypeCheck` derleyici seçeneği kaldırılmıştır. `tsconfig.json` dosyanızda katı şablon tür denetimini etkinleştirmek için bunun yerine `strictTemplates` kullanın.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      '`strictTemplates` derleyici seçeneği artık varsayılan olarak `true` değerine sahiptir. Projeniz katı şablon tür denetimi kullanmıyorduysa, yeni derleme hataları görebilirsiniz. Bu hataları çözün veya devre dışı bırakmak için `tsconfig.json` dosyanızda `strictTemplates: false` değerini açıkça ayarlayın.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      'Webpack derleyicileri (`@angular-devkit/build-angular` ve `@angular-devkit/build-webpack`) artık kullanımdan kaldırılmıştır. Uygulama derlemeleriniz için `@angular/build` derleyicilerine (esbuild/application) geçin.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      "`@angular/ssr` paketindeki `CommonEngine` API'leri kullanımdan kaldırılmıştır. Bunun yerine `AngularNodeAppEngine` veya `AngularAppEngine` paketine geçin.",
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      "`istanbul-lib-instrument` artık isteğe bağlı bir peer bağımlılığıdır. Projeniz kod kapsamı etkinleştirilmiş Karma kullanıyorsa, `istanbul-lib-instrument`'ın açıkça kurulu olduğundan emin olun.",
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      '`ng serve` artık `PORT` ortam değişkenine en yüksek önceliği verir. Bu değer, `angular.json` içinde yapılandırılan veya `--port` bayrağı aracılığıyla sağlanan herhangi bir portu geçersiz kılar.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      '`@angular-devkit/architect-cli` paketi artık kullanılamaz. Bunun yerine `@angular-devkit/architect` paketindeki `architect` CLI aracını kullanın.',
  },
  {
    possibleIn: 2200,
    necessaryAsOf: 2200,
    ...
    action:
      'Deneysel `@angular-devkit/build-angular:jest` ve `@angular-devkit/build-angular:web-test-runner` test derleyicileri kaldırılmıştır.',
  },
];
