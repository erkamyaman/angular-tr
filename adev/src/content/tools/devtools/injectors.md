...
Angular'ın çözümleme yollarını nasıl çözdüğü hakkında daha fazla ayrıntı için [resolution rules](guide/di/hierarchical-dependency-injection#resolution-rules) bölümüne bakın.
