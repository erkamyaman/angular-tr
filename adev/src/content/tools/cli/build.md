...
| Builder                                         | Amaç                                                                                                                                                                                                                                      |
| ----------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `@angular/build:application`                    | [esbuild](https://esbuild.github.io/) ile istemci tarafı paketi, bir Node sunucusu ve derleme zamanı önceden işlenmiş rotalar içeren bir uygulama derler.                                                                                 |
...
| `@angular/build:ng-packagr`                     | [Angular Paket Formatı](tools/libraries/angular-package-format)'na uygun bir Angular kütüphanesi derler.                                                                                                                                  |

`ng new` tarafından oluşturulan uygulamalar varsayılan olarak `@angular/build:application` kullanır.
`ng generate library` tarafından oluşturulan kütüphaneler varsayılan olarak `@angular/build:ng-packagr` kullanır.
...
Bu sayfa `@angular/build:application` kullanımını ve seçeneklerini tartışır.
...
Örneğin, `initial` bütçesi uygulamayı başlatmak için kullanılan JavaScript ve CSS'i ölçer; bu, derleme çıktısı özetinde gösterilen `Initial Total` değerine karşılık gelir.
...
| Özellik        | Değer                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| :------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| type           | Bütçe türü. Şunlardan biri: <table> <thead> <tr> <th> Değer </th> <th> Ayrıntılar </th> </tr> </thead> <tbody> <tr> <td> <code>bundle</code> </td> <td> Belirli bir paketin boyutu. Belirli bir paketi, gecikmeli yüklenen bir paket dahil, bütçelemek için bu türü <code>name</code> ile birlikte kullanın. </td> </tr> <tr> <td> <code>initial</code> </td> <td> Uygulamayı başlatmak için gereken JavaScript ve CSS boyutu. Bu, derleme çıktısı özetinde gösterilen <code>Initial Total</code> değerine karşılık gelir. Varsayılan olarak 500kb'de uyarı ve 1mb'de hata verir. </td> </tr> <tr> <td> <code>allScript</code> </td> <td> Tüm betiklerin boyutu. </td> </tr> <tr> <td> <code>all</code> </td> <td> Tüm uygulamanın boyutu. </td> </tr> <tr> <td> <code>anyComponentStyle</code> </td> <td> Herhangi bir bileşen stil sayfasının boyutu. Varsayılan olarak 2kb'de uyarı ve 4kb'de hata verir. </td> </tr> <tr> <td> <code>anyScript</code> </td> <td> Herhangi bir betiğin boyutu. </td> </tr> <tr> <td> <code>any</code> </td> <td> Herhangi bir dosyanın boyutu. </td> </tr> </tbody> </table> |
| name           | `type=bundle` için paket adı. Bu, builder tarafından raporlanan paket adıdır, oluşturulan çıktı dosyası adı değildir.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| baseline       | Karşılaştırma için temel boyut. Ayarlanmazsa temel değer varsayılan olarak `0` olur ve eşik değerleri bu temel değere göre hesaplanır.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
Gecikmeli yüklenen bir paket için bütçe yapılandırmak üzere `type: "bundle"` kullanın ve `name` değerini o paketin adına ayarlayın.
...
`name` alanı, oluşturulan dosya adıyla değil paket adıyla eşleşir; bu nedenle `admin.*.js` gibi joker karakter veya düzenli ifade kalıpları kullanmaz.

Aşağıdaki örnek, bir temel değer kullanan bir bütçeyi gösterir:
...
Bu örnekte, builder paket `220kb`'nin ötesine büyüdüğünde uyarı verir ve `240kb`'nin ötesine büyüdüğünde hata verir.
