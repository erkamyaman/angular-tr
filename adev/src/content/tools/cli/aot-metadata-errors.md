...
Bildirimin başına `export` eklemek yalnızca yeni bir hata üretir: "[`Only initialized variables and constants can be referenced`](#yalnızca-başlatılmış-değişkenler-ve-sabitler)".
