...
<docs-callout title="Kütüphanenizi adlandırma">
...
Bkz. [Publishing your library](tools/libraries/creating-libraries#kütüphanenizi-yayınlama).
...
## Kod oluşturma şematikleri kullanarak CLI ile entegrasyon
...
## Kendi kütüphanenizi uygulamalarda kullanma
...
### Kütüphanenizi derleme ve yeniden derleme
...
- Uygulamalar için derleme sistemi `@angular/build`, `esbuild` tabanlıdır ve tüm yeni Angular CLI projelerine dahildir
...
### Yerel geliştirme için kütüphaneleri bağlama
...
#### Tüketen uygulamayı yapılandırma
...
## Kütüphane sürüm uyumluluğunu sağlama
...
## Angular CLI dışında partial-Ivy kodunu kullanma
