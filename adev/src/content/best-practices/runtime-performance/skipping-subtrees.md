...
OnPush, Angular'daki varsayilan degisiklik algilama stratejisidir (v22'den beri). Angular'a bir bilesen alt agaci icin degisiklik algilamasini **yalnizca** su durumlarda calistirmasi talimatini verir:
...
Angular, `Eager` stratejisine sahip bir bilesen icinde bir olayı islediginde, framework tum bilesen agacinda degisiklik algilamasi calistirir. Angular, yeni giris almamis OnPush kullanan koklere sahip torun bilesen alt agaclarini atlayacaktir.
