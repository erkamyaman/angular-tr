...
`true` olduğunda, bileşenlerin ve direktiflerin `host` nesne sabitindeki ve `@HostBinding`/`@HostListener` dekoratörlerindeki ifadelerin tür denetimini etkinleştirir.
Varsayılan değer `true`'dur.
