...
Angular ayrıca [birden fazla projeli](#çoklu-projeler) çalışma alanlarını da destekler.
...
Aşağıdaki [Çoklu proje çalışma alanı kurulumu](#çoklu-projeler) bölümüne bakın.
