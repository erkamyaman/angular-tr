...
<docs-card-container>
  <docs-card title="Standalone" link="Şimdi taşı" href="reference/migrations/standalone">
  ...
  <docs-card title="Control Flow Syntax" link="Şimdi taşı" href="reference/migrations/control-flow">
  ...
  <docs-card title="inject() Function" link="Şimdi taşı" href="reference/migrations/inject-function">
  ...
  <docs-card title="Lazy-loaded routes" link="Şimdi taşı" href="reference/migrations/route-lazy-loading">
  ...
  <docs-card title="New `input()` API" link="Şimdi taşı" href="reference/migrations/signal-inputs">
    Mevcut `@Input` alanlarını artık üretime hazır olan yeni sinyal girdi API'sine dönüştürün.
  </docs-card>
  <docs-card title="New `output()` function" link="Şimdi taşı" href="reference/migrations/outputs">
    Mevcut `@Output` özel olaylarını artık üretime hazır olan yeni output fonksiyonuna dönüştürün.
  </docs-card>
  <docs-card title="Queries as signal" link="Şimdi taşı" href="reference/migrations/signal-queries">
    Mevcut dekoratör sorgu alanlarını geliştirilmiş sinyal sorguları API'sine dönüştürün. API artık üretime hazırdır.
  </docs-card>
  <docs-card title="Cleanup unused imports" link="Şimdi dene" href="reference/migrations/cleanup-unused-imports">
    Projenizdeki kullanılmayan içe aktarmaları temizleyin.
  </docs-card>
  <docs-card title="Self-closing tags" link="Şimdi taşı" href="reference/migrations/self-closing-tags">
    Bileşen şablonlarını mümkün olduğunda kendinden kapanan etiketler kullanacak şekilde dönüştürün.
  </docs-card>
  <docs-card title="NgClass to Class Bindings" link="Şimdi taşı" href="reference/migrations/ngclass-to-class">
      Bileşen şablonlarını mümkün olduğunda `NgClass` direktifleri yerine sınıf bağlamalarını tercih edecek şekilde dönüştürün.
  </docs-card>
  <docs-card title="NgStyle to Style Bindings" link="Şimdi taşı" href="reference/migrations/ngstyle-to-style">
      Bileşen şablonlarını mümkün olduğunda `NgStyle` direktifleri yerine stil bağlamalarını tercih edecek şekilde dönüştürün.
  </docs-card>
  <docs-card title="RouterTestingModule migration" link="Şimdi taşı" href="reference/migrations/router-testing-module-migration">
  ...
  <docs-card title="CommonModule to standalone imports" link="Şimdi taşı" href="reference/migrations/common-to-standalone">
