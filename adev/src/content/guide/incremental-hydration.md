...
Artımlı Hidrasyon, [olay tekrarına](guide/hydration#olayları-yakalama-ve-yeniden-oynatma) bağımlıdır ve otomatik olarak etkinleştirir. Listenizde zaten `withEventReplay()` varsa, artımlı hidrasyonu etkinleştirdikten sonra güvenle kaldırabilirsiniz.
