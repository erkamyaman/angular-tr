...
NOTE: `required`, boş dizi için `true` döndürür. Dizileri doğrulamak için [`minLength()`](#minlength-ve-maxlength) kullanın.
...
<!-- TODO: KILAVUZLAR MEVCUT OLDUĞUNDA YORUMU KALDIRIN -->
<docs-pill-row>
