...
## Bileşen şablonunda metni işaretleme {#mark-text-in-component-template}
...
Bu, bileşen kodunda bir yer tutucuyu [`$localize`][ApiLocalizeInitLocalize] ile adlandırmanın şablondaki karşılığıdır:
