...
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `on`        | Yerleşik tetikleyiciler listesinden bir tetikleyici kullanan tetikleme koşulu.<br/>Örneğin: `@defer (on viewport)`                                                               |
| `when`      | Doğruluk değeri için değerlendirilen bir ifade koşulu. İfade doğru olduğunda, yer tutucu tembel yüklenen içerikle değiştirilir.<br/>Örneğin: `@defer (when customizedCondition)` |
