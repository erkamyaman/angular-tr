...
<docs-card title="Playground" href="/playground" link="Oyun Alanında Aç" iconImgSrc="adev/src/assets/icons/playground.svg" titleInline>
...
Terminalinizde, istediğiniz proje adıyla [`ng new`](cli/new) CLI komutunu çalıştırın. Aşağıdaki örneklerde, `my-first-angular-app` örnek proje adını kullanacağız.
